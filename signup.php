...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($_POST['Nombres'])) {
    ...
    if (!preg_match("/^[a-zA-Z ]+$/", $nombres)) {
      $nombresErr = "Solo se permiten letras y espacios en el nombre.";
    }
  }
  ...
  if (empty($_POST['Apellidos'])) {
    ...
    //Validar que los apellidos sean solo letras y espacios
    if (!preg_match("/^[a-zA-Z ]+$/", $apellidos)) {
      $apellidosErr = "Solo se permiten letras y espacios en el apellido.";
    }
  }
  ...
  if (empty($_POST['Usuario'])) {
    ...
    if (!preg_match("/^[a-zA-Z0-9]+$/", $usuario)) {
      $usuarioErr = "Solo se permiten letras y números en el nombre de usuario.";
    }
  }
